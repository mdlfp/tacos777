...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Taqueria777 los mejores tacos de ensenada desde decadas visita nuestras diferentes sucursales en calle delante, porticos, cortez '>;
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Taqueria777'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    redesSociales: Schema.Attribute.Component<'component.social-link', true>;
...
export interface ApiSucursalSucursal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    horario: Schema.Attribute.Component<'bussines.opening-hours', true> &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    mapLink: Schema.Attribute.Component<'component.link', false>;
